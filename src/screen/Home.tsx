  ...
  return (
    <RootLayout>
      <View style={{ marginLeft: 4 }}>
        ...
        <Text>
          default text Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, hic optio
          enim officia temporibus corrupti repudiandae dolor commodi delectus, incidunt, fugiat
          deserunt! Fugiat maiores tenetur harum officiis perferendis, repudiandae sed.
        </Text>
